...
def extract_catalog_headers(vndr):
	...
	catalog_filename = "../Data/" + vndr + "-catalog.tsv"
...
def arrange_catalog(collections, vndr):
	...
	for collection_idx in range(len(collections)):
		...
		variants = collection.isolate_variants(init_collection, product_type, variant_option_names)
...
def determine_valid_product_type(p_type):
	...
	valid_types = [ "bedroom sets", "wardrobes", "nightstand sets" ] # next add "dresser-chest sets"
