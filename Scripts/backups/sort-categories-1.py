...
input_linked_products = isolate_linked_products(input_collections)
...
for row_idx in range(len(input_collections)):

	init_collection_info = input_collections[row_idx].split("\",")
	for info in range(len(init_collection_info)):
		init_collection_info[info] = init_collection_info[info].replace("\"", "")
