...
input_category = collection.isolate_categories(input_collection)[0]
...
input_linked_products = collection.isolate_collection_field(input_category, "linked products")
