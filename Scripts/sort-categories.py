...
#
# Example 3: move products with tag containing "sale" and "Presidents" and "Day" and "2020"
# sort-categories.py all-categories tag sale presidents day 2020
#
...
# after all linked products are sorted separately for separate collections, arrange 1 collection at a time, and then bring them together in sequence
arranged_collection = collection.arrange_collection(input_collection, sorted_linked_products)

category_fields = ["ID", "Handle", "Command", "Title", "Sort Order",
...
collection.write_collection(arranged_collection, collection_arg, category_fields)
